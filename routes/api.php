...
Route::get('searchEvent/{key}',[EvenementController::class , 'searchEvent']);
...
Route::put('UpdateEvent/{id}',[EvenementController::class,'UpdateEvent']);
Route::put('UpdatePromo/{id}',[PromotionController::class,'UpdatePromo']);
